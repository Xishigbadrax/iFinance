                    ...
                    <div className=" flex justify-center   ">
                      <div className=" ">
                        <div className=" flex justify-start">
                          ...
                          <div className={`text-[#2E28D4]  text-[18px] font-bold  hover:opacity-100 ${hover == 1 ? "opacity-100" : "opacity-50"} `}>
                        ...
                        <div className=" flex justify-start my-[20px]">
                          ...
                          <div className={`text-[#2E28D4]  text-[18px] font-bold  hover:opacity-100 ${hover == 2 ? "opacity-100" : "opacity-50"} `}>
                        ...
                        <div className=" flex justify-start">
                          ...
                          <div className={`text-[#2E28D4]  text-[18px] font-bold  hover:opacity-100 ${hover == 3 ? "opacity-100" : "opacity-50"} `}>
                        ...
                        <div className=" flex justify-start mt-[20px]">
                          ...
                          <div className={`text-[#2E28D4]  text-[18px] font-bold  hover:opacity-100 ${hover == 4 ? "opacity-100" : "opacity-50"} `}>
                            Тохиргоо
                          </div>
                        </div>
                        <Divider />

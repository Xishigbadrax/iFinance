...
import { Image, Divider, Tabs, Checkbox, Button, Input } from "antd";
          ...
          <Tabs className="infoTab" defaultActiveKey="1">
            ...
            >
              <div className=" px-10 md:px-0">
                ...
                <div className=" grid lg:grid-cols-3 gap-4 mt-[32px]">
                  <div>
                    <TextField
                      id="standard-basic"
                      InputProps={{
                  ...
                  <div>
                    <TextField
                      ...
                      label="Тоот дугаар /хашааны дугаар"
                      defaultValue="Бат-Эрдэнэ"
                      variant="standard"
                    />
                  </div>
